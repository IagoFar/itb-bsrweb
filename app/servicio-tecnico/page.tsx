  ...
  return (
    <div className="bg-blue-50 grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="grid grid-cols-3 grid-rows-1 items-start mt-50 pl-5">
        <div>
          <h2 className="text-3xl font-bold"><FontAwesomeIcon icon={faCircleInfo}/> Reparación de servidores</h2>  {/* Subtema 1 */}
          <p className="text-2xl text-zinc-800 pr-10 mt-10">Cualquier error dentro de tu servidor lo arreglamos.</p>  {/* Info 1 */}
        </div>
        <div>
          <h2 className="text-3xl font-bold"><FontAwesomeIcon icon={faCircleInfo}/> Mantenimiento de servidores</h2>  {/* Subtema 2 */}
        ...
        <div>
          <h2 className="text-3xl font-bold"><FontAwesomeIcon icon={faCircleInfo}/> Instalacion de hardware</h2>  {/* Subtema 3 */}
      ...
      <div className="grid grid-cols-3 grid-rows-1 items-start mt-50 pl-5">
        <div>
          <h2 className="text-3xl font-bold"><FontAwesomeIcon icon={faCircleInfo}/> Optimizacion de rendimiento</h2>  {/* Subtema 4 */}
        ...
        <div>
          <h2 className="text-3xl font-bold"><FontAwesomeIcon icon={faCircleInfo}/> Actualizacion de sistemas operativos</h2>  {/* Subtema 5 */}
        ...
        <div>
          <h2 className="text-3xl font-bold"><FontAwesomeIcon icon={faCircleInfo}/> Clientes</h2>  {/* Subtema 6 */}
